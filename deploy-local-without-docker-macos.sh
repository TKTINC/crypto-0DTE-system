...
# Delta Exchange Configuration - UPDATED TO MATCH CONFIG.PY
# Production API Keys (for live trading)
DELTA_API_KEY=$DELTA_EXCHANGE_API_KEY
DELTA_API_SECRET=$DELTA_EXCHANGE_API_SECRET
DELTA_API_PASSPHRASE=

# Testnet API Keys (for paper trading) 
DELTA_TESTNET_API_KEY=$DELTA_EXCHANGE_API_KEY
DELTA_TESTNET_API_SECRET=$DELTA_EXCHANGE_API_SECRET
